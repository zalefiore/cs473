...
const fxpt_4_28 FRAC_WIDTH = (fxpt_4_28)3 << FXPT_FRAC_BITS;    //!< default fractal width (3.0 in Q4.28)
const fxpt_4_28 CX_0 = -((fxpt_4_28)2 << FXPT_FRAC_BITS);       //!< default start x-coordinate (-2.0 in Q4.28)
const fxpt_4_28 CY_0 = -((fxpt_4_28)3 << (FXPT_FRAC_BITS - 1)); //!< default start y-coordinate (-1.5 in Q4.28)
